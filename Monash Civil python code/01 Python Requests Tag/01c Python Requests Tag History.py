...
def write_tag(webServices, tag_path, tag_properties, tag_value, tag_workspace):
    tag = {'collectAggregates': True, 'keywords': None, 'path': tag_path, 'properties': tag_properties, 'type': 'DOUBLE', 'workspace': tag_workspace}
...
def tag_io(webServices):
    ...
    tag_path = "NI_MXIe-8133_Embedded_Controller--MAC-00-80-2F-12-7F-31.Ownership.Status.Value"
    tag_properties = {"IsConformed": "true", "Department": "OPS", "IsReleased": "true"}
    tag_properties["nitagRetention"] = "DURATION" # PERMANENT|NONE|COUNT|DURATION
    tag_properties["nitagHistoryTTLDays"] = 3
    tag_properties["nitagMaxHistoryCount"] = 10
    tag_value = {"value": {"type": "DOUBLE", "value": 1.7}, "timestamp": now}
    tag_workspace = None # workspace = Default
    #tag_workspace = "93f869bd-f4df-4fb6-84e3-0499cae06a7c" # workspace != Default (foo)
